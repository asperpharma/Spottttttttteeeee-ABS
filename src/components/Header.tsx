            ...
            <div className="flex-1 flex items-center justify-end gap-2 md:gap-4">
              ...
              >
                ...
                <input
                  ...
                  placeholder={language === "ar" ? "Ø§Ø¨Ø­Ø« ÙÙŠ Ø¢Ù„Ø§Ù Ø§Ù„Ù…Ù†ØªØ¬Ø§Øª..." : "Search 6,500+ products..."}
                  className={cn(
        ...
        <div className="md:hidden border-t border-rose-clay-light/30 bg-polished-white p-3">
          <div className="relative">
            <input
              ...
              placeholder={language === "ar" ? "Ø§Ø¨Ø­Ø« ÙÙŠ Ø§Ù„Ù…Ù†ØªØ¬Ø§Øª..." : "Search 6,500+ products..."}
