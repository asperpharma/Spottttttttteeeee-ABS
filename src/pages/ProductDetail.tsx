                  ...
                  <div className="py-2 space-y-4">
                    ...
                    <div className="p-3 bg-destructive/5 border border-destructive/20 rounded-lg">
                      ...
                      <ul className="space-y-1.5 text-xs">
                        <li>• {isArabic ? "Ù„Ù„استخداÙ… اÙ„خارجÙŠ فÙ‚ط. تجÙ†بÙŠ Ù…Ù„اÙ…سة اÙ„عÙŠÙ†ÙŠÙ†." : "For external use only. Avoid contact with eyes."}</li>
                        <li>• {isArabic ? "تÙˆÙ‚فÙŠ عÙ† اÙ„استخداÙ… فÙŠ حاÙ„ حدÙˆث تÙ‡ÙŠج." : "Discontinue use if irritation occurs."}</li>
                        <li>• {isArabic ? "ÙŠُحفظ بعÙŠداÙ‹ عÙ† Ù…تÙ†اÙˆÙ„ اÙ„أطفاÙ„." : "Keep out of reach of children."}</li>
                        <li>• {isArabic ? "ÙŠُخزÙ† فÙŠ درجة حرارة أÙ‚Ù„ Ù…Ù† 25 درجة Ù…ئÙˆÙŠة." : "Store below 25°C. Protect from direct sunlight."}</li>
                      </ul>
                    </div>
