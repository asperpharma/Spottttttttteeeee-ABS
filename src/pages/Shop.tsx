...
export default function Shop() {
  ...
  // Reset to page 0 whenever section changes
  useEffect(() => {
    setPage(0);
    setProducts([]);
    setHasMore(true);
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Filter by section at DB level — much more efficient than client-side
        if (sectionParam) {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return sorted;
  }, [products, filters, sectionParam, sortBy]);
                  ...
                  {hasMore && (
                    <div className="flex justify-center pt-10">
                      <button
                        ...
                        className="px-8 py-3 bg-burgundy text-polished-white font-body font-medium text-sm uppercase tracking-widest hover:bg-burgundy-light transition-colors"
                      >
